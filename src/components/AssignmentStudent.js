...
class AssignmentStudent extends Component {
  ...
  handleSubmitAns = () => {
    ...
    const url = `https://backend-deploy-1-8qp1.onrender.com/assignment/submit`;
    ...
    return (
      <div className="assignment-container-box-element">
        <div className="assignment-container-box-element-teacherName">
          <i style={{ "font-size": ".8rem", color: "yellow" }}>given by</i>{" "}
          {teacherName}
        </div>
        <div className="assignment-container-box-element-subName">
          <i style={{ "font-size": ".8rem", color: "yellow" }}>subject</i>{" "}
          {subject}
        </div>
        <div className="assignment-container-box-element-assignmentName">
          <i style={{ "font-size": ".8rem", color: "yellow" }}>
            assignment name{" "}
          </i>{" "}
          {assignmentName}
        </div>
        <div className="assignment-container-box-element-lastDate">
          <i style={{ "font-size": ".8rem", color: "yellow" }}>last date </i>{" "}
          {lastDate}
        </div>
        <div className="assignment-container-box-element-content">
          {img !== undefined && (
            <div className="assignment-container-box-element-content-img">
              <div className="assignment-img-container">
                <img alt="assignment pic" src={img} />
              </div>
              <div className="assignment-img-name-container">
                Assignment.jpg
              </div>
            </div>
          )}
          {pdfurl !== null && (
            <div className="assignment-container-box-element-content-pdf">
        ...
        <div className="assignment-container-box-element-submitButton">
          ...
          {submittedStatus && (
            <div className="submitButton submittedButton">Submitted</div>
          )}
        </div>
      </div>
    );
