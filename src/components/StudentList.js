...
class StudentList extends Component {
  ...
  render() {
    ...
    let name =
      this.props.student.name.length > 17
        ? this.props.student.name.substring(0, 15) + ".."
        : this.props.student.name;
    return (
      <div className="student-list-displayer">
        <div
          className="student-list-displayer-name"
          onClick={() => this.handleProfileClickOpen(this.props.student._id)}
        >
          <Link to="/profile" id="linkyName">
            {name}
          </Link>
        </div>
        <div
          className="student-list-displayer-present"
        ...
        <div
          className="student-list-displayer-absent"
